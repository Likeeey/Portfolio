            ...
            <Container style={{ marginTop: "80px"}}>
                <Row className="justify-content-md-center">
                    ...
                    <Col xs={12} sm={12} md={7} lg={3} className="text-start">
                        ...
                        <p>After searching for a field where ongoing learning would truly enrich my career and personal growth, I discovered programming. As soon as the opportunity appeared, I've made the decision to transition careers. I've enlisted in Ironhack and here I am.</p>
                        <p>It's amazing all the technologies and different languages you can learn in this world. We truly never stop learning, and we need a razor-sharp mind for every problem encountered. It can be stressful but rewarding at the end.</p>
